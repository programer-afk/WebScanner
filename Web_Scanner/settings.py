...
DEBUG = True  # 开发环境可以开启调试模式

ALLOWED_HOSTS = ['*']  # 允许所有主机访问，包括公网IP
...
API_URL = ''  # 已部署AWVS服务器地址
API_KEY = '1986ad8c0a5b3df4d7028d5f3c06e936c669b9e7451db414fbe65523c192a5914'  # AWVS API密钥
API_TIMEOUT = 60  # AWVS API请求超时时间(秒)
...
X_FRAME_OPTIONS = 'SAMEORIGIN'  # 修改为SAMEORIGIN以允许同源iframe
